          ...
          <CardContent className="p-6">
            {done ? (
              ...
              <form onSubmit={submit} className="grid gap-3 sm:grid-cols-2">
                <F label="Name *" v={form.name} on={(v) => setF("name", v)} testid="rd-name" />
                <F label="Company" v={form.company} on={(v) => setF("company", v)} testid="rd-company" />
                <F label="Email" v={form.email} on={(v) => setF("email", v)} type="email" testid="rd-email" />
                <F label="Phone" v={form.phone} on={(v) => setF("phone", v)} testid="rd-phone" />
